# Fashion Star 总线伺服舵机 Python SDK API 说明

来源：https://fashionstar.com.hk/wiki/zh/sdk/servo/python-sdk/

生成日期：2026-06-28

说明：本文件将网页正文整理为 Markdown 文本，已省略图片、图标和网页装饰元素；主要保留 API 说明、参数/返回值表、列表与代码块。
...
本 SDK 基于 Fashion Star 总线伺服舵机的 UART/RS485 通信协议 开发，提供 Python API，适用于全系列舵机型号。
...
- 请下载并安装USB转TTL模块的驱动程序。

### 2.2 总线伺服舵机调试软件

- 请参考《总线伺服舵机调试软件》提前分配 ID 或修改配置参数。
...
注意事项： 如需修改用户自定义参数，建议在上位机中操作，更加方便直观。
